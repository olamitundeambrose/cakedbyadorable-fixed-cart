        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm font-medium text-black">Handcrafted with Love</span>
            </motion.div>

            <h1 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-serif font-medium text-black leading-tight mb-6">
              Creating Sweet
              <span className="block text-pink-400">Memories</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center lg:justify-start">
              ...
              <Link to={createPageUrl('CakeShop')}>
                <Button 
                  size="lg" 
                  variant="outline"
                  className="border-2 border-black text-black hover:bg-black hover:text-white px-8 py-6 text-base rounded-full transition-all duration-300 hover:-translate-y-0.5"
                >
                  View Gallery
                </Button>
              </Link>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="font-semibold text-black">2,500+</p>
                  </div>
                </div>
              </motion.div>
